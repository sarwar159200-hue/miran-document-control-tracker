# MDCT V3.3.1 Deployment

1. Upload the `MDCT-V3.3.1-DEEP-ATTACHMENT-AUDIT` folder to the GitHub repository root.
2. In Vercel set **Root Directory** exactly to:
   `MDCT-V3.3.1-DEEP-ATTACHMENT-AUDIT`
3. Save and redeploy.
...
No new Supabase SQL is required for V3.3.1 if migration 04 was already run.
